...
namespace Ex03.GarageLogic.VehiclesInfo
{
    ...
    {
        public MotorcycleInfo(string i_VehicleModelName, string i_WheelsManufacturerName, string i_LicensePlate, int i_NumberOfWheels,
        ...
        {
            return string.Format("{0}, License type: {1}, Engine volume: {2}", base.ToString(), LicenseType, EngineVolume);
        }
    }
}
