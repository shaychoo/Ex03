...
namespace Ex03.GarageLogic
{
    public static class VehicleCreation
    {
        ...
        {
            VehicleInfo vehicleInfo = getVehicleInfo(i_VehicleType, i_ModelName, i_LicensePlate, i_SpecificVehicleParams);
            EnergySource energySource = getEnergySource(i_VehicleType, i_EnergySourceType, i_CurrentEnergyAmount);
            Vehicle resultVehicle = getVehicle(i_VehicleType, vehicleInfo, energySource);
        ...
        private static Vehicle getVehicle(eVehicleType i_VehicleType, VehicleInfo vehicleInfo, EnergySource energySource)
        {
            ...
            switch (i_VehicleType)
            {
                case eVehicleType.Car:
                    resultVehicle = new Car(vehicleInfo, energySource);
                    break;
                case eVehicleType.Motorcycle:
                    resultVehicle = new Motorcycle(vehicleInfo, energySource);
                    break;
                case eVehicleType.Truck:
                    resultVehicle = new Truck(vehicleInfo, energySource);
                    break;
                default:
        ...
        private static VehicleInfo getVehicleInfo(eVehicleType i_VehicleType, string i_ModelName, string i_LicensePlate,
            object[] i_SpecificVehicleParams)
        {
            ...
            switch (i_VehicleType)
            {
                case eVehicleType.Car:
                    ...
                    vehicleInfo = new CarInfo(i_ModelName, i_LicensePlate, Constants.k_CarWheelsNumber,
                ...
                case eVehicleType.Motorcycle:
                    ...
                    vehicleInfo = new MotorcycleInfo(i_ModelName, i_LicensePlate, Constants.k_MotorcycleWheelsNumber,
                        Constants.k_MotorcycleWheelsMaxAirPressure, licenseType, engineVolume);

                    break;
                case eVehicleType.Truck:

                    vehicleInfo = new TruckInfo(i_ModelName, i_LicensePlate, Constants.k_TruckWheelsNumber,
